...
/*sortingbyvalue*/
function sortby(block, value, asc='asc') {
    //find block for sorting
    var $wrapper=$(block);
    var items=$wrapper.find('.sorting-item');
    //sort
    //console.log(value);
    ...
    var pagify = {
        ...
        navigate: function(next) {
            ...
            if (next) {
                ...
                if (this.currentPage == (this.totalPages - 1))
                    $(".custom-pagination .nav.next").addClass("disabled");
            }
            else {
                this.currentPage--;
                if (this.currentPage < 0)
                    this.currentPage = 0;
                if (this.currentPage == 0)
                    $(".custom-pagination .nav.prev").addClass("disabled");
            }
